...
public class Esercizio7 {
    ...
    con le stesse frequenze. Ad esempio, gli anagrammi di CAT sono CAT,ACT,TAC,TCA,ATC, e CTA.
    Date due stringhe a e b in input, stampare «anagrammi» se sono anagrammi (case-insensitive),
    «non anagrammi» altrimenti.
     */

    public static void isAnagrammi(String a,String b){
    ...
    //Soluzione non testata ma valida
